...
document.getElementById('search').addEventListener("change", (e) => {
    ...
    rows.forEach((r, idx) => {
        if (idx >= 1 && (r.cells[0].textContent.includes(search)||r.cells[1].textContent.includes(search)||r.cells[2].textContent.includes(search)||r.cells[3].textContent.includes(search))) {
            //console.log(r.cells[2].textContent);
            r.style.display = "";
        }
        else {
